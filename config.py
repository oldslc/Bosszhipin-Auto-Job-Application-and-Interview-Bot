...
PERSONA = """
我是[姓名]，[毕业年份]年毕业于[学校][专业]。
曾在[公司]负责[工作内容]，后自主经营[业务]2年。
...
# MQTT 模式配置
# ============================================================
# MQTT_MODE = True 时，使用 MQTT 直连代替浏览器发送/接收消息
# 优点：不需要浏览器，更隐蔽，效率更高
# 缺点：需要额外的 cookie 配置（需先从浏览器导出 cookie 到 data/cookie.txt）
MQTT_MODE = os.environ.get("BOSS_MQTT_MODE", "false").lower() == "true"
